...
writeFileSync(
  "/home/runner/work/dev-edu/dev-edu/expansions_batch4.json",
  JSON.stringify({
    "be-backend-testing": { append: makeTesting() },
    "be-authn": { append: makeAuthn() },
    "be-jwt": { append: makeJwt() },
    "be-crypto": { append: makeCrypto() },
    "be-prisma-drizzle": { append: makePrismaDrizzle() },
    "be-kysely": { append: makeKysely() },
    "be-llm-fundamentals": { append: makeLlmFundamentals() },
    "be-rag": { append: makeRag() },
    "be-ai-production": { append: makeAiProduction() }
  }, null, 2),
  "utf8"
);
console.log("Done");
